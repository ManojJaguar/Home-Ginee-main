    ...
    <>
      <footer className="footer">
        <div className="footer__container">
          <div className="footer_left">
            ...
            <div className="footer_address">
              <strong> homegenieeservice@gmail.com </strong>
              <strong> +91 9113xxxxx </strong>
            </div>
        ...
        <div className="footer_bottom">
          <p>
            © {getCurrentYear()} Home Services. All Rights Reserved 
            <a
              href="https://github.com/Shashidhar-Nandi/"
              target="_blank"
              rel="noreferrer"
